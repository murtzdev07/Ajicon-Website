...
export default function Navbar() {
  ...
  return (
    // Fixed wrapper to center the floating pill
    <div className="fixed top-0 left-0 right-0 z-50 flex justify-center px-4 pt-6 pointer-events-none">
      ...
      <nav 
        ...
        `}
      >
        {/* Logo Area (Slim Navbar, Larger Visual Logo) */}
        <a href="#home" className="flex items-center gap-2 pl-2 md:pl-4 cursor-pointer transition-transform active:scale-95">
          {/* Container remains small (w-10 h-10) so the navbar stays thin */}
          <div className="w-10 h-10 flex items-center justify-center">
            {/* The image is scaled up visually (scale-[1.4] on mobile, scale-[2.0] on desktop) */}
            <img 
              src="/logo.png"   
          ...
          {/* Adjusted margin to account for the overlapping scaled logo */}
        ...
        {/* Desktop Links - "Pill inside a Pill" style */}
        ...
        <div className="flex items-center gap-2 pr-1">
          {/* Desktop CTA using brand color theme */}
          <a 
            href="#contact" 
